...
class Offer extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('position, live, showonhp, continent_code', 'required'),
            array('hotel_id, position, live, showonhp', 'numerical', 'integerOnly' => true),
            array('continent_code', 'length', 'max' => 2),
            array('expiry', 'length', 'max' => 10),
            array('title', 'length', 'max' => 220),
            array('offer', 'safe'),
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array('id, hotel_id, offer, expiry, position, live, showonhp', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function relations() {
        ...
        return array(
            ...
            'continent' => array(self::BELONGS_TO, 'Continent', 'continent_code')
        );
    }
    ...
    public function search() {
        ...
        $criteria->compare('showonhp', $this->showonhp);
