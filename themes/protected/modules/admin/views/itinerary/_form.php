...
<!--		
	...
	<div class="group">
		...
		<?php endif; ?>
		<?php echo $form->textArea($model, 'image', array('rows' => 6, 'cols' => 50, 'class' => 'text_area')); ?>
	</div>
	...
	<div class="group">
		...
		<?php endif; ?>
		<?php echo $form->textArea($model, 'image2', array('rows' => 6, 'cols' => 50, 'class' => 'text_area')); ?>
	</div>
	...
	<div class="group">
		...
		<?php endif; ?>
		<?php echo $form->textArea($model, 'image3', array('rows' => 6, 'cols' => 50, 'class' => 'text_area')); ?>
	</div>
	...
	<div class="group">
		...
		<?php endif; ?>
		<?php echo $form->textArea($model, 'image4', array('rows' => 6, 'cols' => 50, 'class' => 'text_area')); ?>
	</div>
-->		
	<div class="group">
