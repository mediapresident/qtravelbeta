<?php $form = $this->beginWidget('CActiveForm', array(
	...
	<div class="group">
		<?php if($model->hasErrors('show_hp')): ?>
			<div class="fieldWithErrors">
		<?php endif; ?>
		<?php echo $form->labelEx($model, 'show_hp', array('class' => 'label')); ?>
		<?php if ($model->hasErrors('show_hp')): ?>
				<span class="error"><?php echo $model->getError('show_hp'); ?></span>
			</div>
		<?php endif; ?>
		<?php echo $form->textField($model, 'show_hp', array('class' => 'text_field')); ?>
	</div>
